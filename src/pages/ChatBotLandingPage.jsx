      ...
      <section id="banner" className="h-screen relative text-white">
        ...
        >
          ...
          <p className="sub-heading">
            At AIPROTOX, we specialize in creating intelligent, scalable, and
        ...
        <div className="grid lg:grid-cols-2 gap-10 mt-7">
          ...
          >
            <div className="flex flex-col items-center lg:items-start gap-5 text-center lg:text-start">
              ...
              <p className="desc">
                At AIPROTOX, we specialize in creating intelligent chatbots that
          ...
          <div className="bg-black rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-8">
              ...
              <section className="mb-12">
                ...
                >
                  Why Choose AIPROTOX for Chatbot Development?
                </h2>
              ...
              <div className="text-center">
                <p data-aos="fade-up" className="text-xl mb-4">
                  Transform your customer experience with AIPROTOX's chatbot
                  solutions.
                </p>
