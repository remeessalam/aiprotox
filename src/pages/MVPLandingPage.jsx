...
const MVPLandingPage = () => {
  const whyChooseReasons = [
    ...
    },
    {
      ...
      description:
        "Time is of the essence for startups and entrepreneurs. With AIPROTOX, you can launch your MVP quickly to gather user feedback, validate your idea, and adapt as needed.",
    },
    {
      icon: <FaSync />,
      ...
      <div className="font-sans">
        ...
        {/* <div className="relative h-screen flex items-center justify-center bg-gradient-to-r from-blue-500 to-purple-600 text-white">
          ...
          <div className="relative z-10 text-center px-4">
            ...
            <p className="text-xl md:text-2xl mb-8">
              Turning Ideas into Reality with AIPROTOX
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-10 mt-7">
            ...
            >
              <div className="flex flex-col items-center lg:items-start gap-5 text-center lg:text-start">
                ...
                <p className="desc">
                  At AIPROTOX, we empower innovators and entrepreneurs by
        ...
        <section className="bg-blue-600 text-white py-16 px-4 text-center">
          ...
          <p data-aos="fade-up" className="text-xl mb-8">
            Partner with AIPROTOX to develop your MVP and turn your dreams into
            reality.
          </p>
          <button
            data-aos="fade-up"
